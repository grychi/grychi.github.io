document.addEventListener('DOMContentLoaded', function () {
	...
	$("#expB").click(function() {
		$("#resChange").html(`
			<br><p>FindU is a small startup that was founded in 2014. While working with their team, I did a majority of front-end web development work along with some back-end work.</p>
		`);
	});
	$("#expMore").click(function() {
		$("#resChange").html(`
			<br><p>Think I can help with something? As I am pursuing experiential learning opportunities, I'd be glad to hear what you have in mind. I am willing to work hard and assist with the goals of the internship. Even if you aren't looking for a front-end web developer or graphic designer, I would still appreciate learning about the oppurtunity. I am a full-time student so hopefully, we can work out a schedule. If all is well, <a href="#contact">leave me a message</a> and we can discuss further.</p>
		`);
	});
